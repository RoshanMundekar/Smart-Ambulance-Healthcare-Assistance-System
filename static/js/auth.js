...
function initWebSocket(userId) {
  if (!userId || ws) return;
  const wsUrl = `ws://${location.host}/api/emergency/ws/${userId}`;
...
function handleWsMessage(msg) {
  if (msg.type === 'notification') {
    ...
    if (typeof updateEmergencyUI === 'function') {
      updateEmergencyUI(msg.data);
    } else if (typeof updateEmergencyCard === 'function') {
